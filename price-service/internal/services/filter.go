...
func (filter *ProductsFilter) FilterByMarkets(ctx echo.Context, product entities.ProductRequest) ([]entities.ProductResponse, error) {
...
// the price range.
func (filter *ProductsFilter) FilterByPriceRange(ctx echo.Context, product entities.ProductRequest, priceDown int, priceUp int) ([]entities.ProductResponse, error) {
...
func (filter *ProductsFilter) FilterByBestPrice(ctx echo.Context, product entities.ProductRequest) ([]entities.ProductResponse, error) {
...
func (filter *ProductsFilter) FilterByExactPrice(ctx echo.Context, product entities.ProductRequest, exactPrice int) ([]entities.ProductResponse, error) {
